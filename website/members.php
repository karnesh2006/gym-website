...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="adminn-login.php"><img src="logo.jpg" alt="Logo"></a>
...
<form>
  ...
  <div class="form-group">
    <label for="inputAddress">Coach</label>
    <input type="text" name="coach" class="form-control" id="inputAddress" placeholder="coach">
  </div>
  <div class="form-group">
